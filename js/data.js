...
const DESTS = [
  { id: 'paris', name: 'Paris', country: 'France', emoji: '🗼', c: ['#f472b6', '#6366f1'], cats: ['City', 'Culture'], climate: 'mild', season: 'Apr–Jun, Sep–Oct', cost: { stay: 140, food: 45, transport: 15 },
  ...
  { id: 'bali', name: 'Bali', country: 'Indonesia', emoji: '🏝️', c: ['#34d399', '#0ea5e9'], cats: ['Beach', 'Nature', 'Culture'], climate: 'warm', season: 'Apr–Oct', cost: { stay: 45, food: 20, transport: 8 },
  ...
  { id: 'tokyo', name: 'Tokyo', country: 'Japan', emoji: '🏯', c: ['#fb7185', '#7c3aed'], cats: ['City', 'Culture'], climate: 'mild', season: 'Mar–May, Oct–Nov', cost: { stay: 100, food: 35, transport: 12 },
  ...
  { id: 'capetown', name: 'Cape Town', country: 'South Africa', emoji: '⛰️', c: ['#38bdf8', '#f97316'], cats: ['Adventure', 'City', 'Nature'], climate: 'mild', season: 'Nov–Mar', cost: { stay: 60, food: 25, transport: 10 },
  ...
  { id: 'victoriafalls', name: 'Victoria Falls', country: 'Zambia / Zimbabwe', emoji: '🌈', c: ['#22d3ee', '#16a34a'], cats: ['Adventure', 'Nature'], climate: 'warm', season: 'Apr–Jul (high water)', cost: { stay: 70, food: 25, transport: 10 },
  ...
  { id: 'santorini', name: 'Santorini', country: 'Greece', emoji: '🌅', c: ['#60a5fa', '#f0abfc'], cats: ['Beach', 'Culture'], climate: 'warm', season: 'May–Oct', cost: { stay: 130, food: 45, transport: 10 },
  ...
  { id: 'machupicchu', name: 'Machu Picchu', country: 'Peru', emoji: '🦙', c: ['#a3e635', '#0f766e'], cats: ['Adventure', 'Culture', 'Nature'], climate: 'cool', season: 'May–Sep', cost: { stay: 55, food: 25, transport: 20 },
  ...
  { id: 'newyork', name: 'New York', country: 'USA', emoji: '🗽', c: ['#f59e0b', '#1d4ed8'], cats: ['City', 'Culture'], climate: 'mild', season: 'Apr–Jun, Sep–Nov', cost: { stay: 200, food: 60, transport: 15 },
  ...
  { id: 'maldives', name: 'Maldives', country: 'Maldives', emoji: '🐠', c: ['#22d3ee', '#3b82f6'], cats: ['Beach', 'Nature'], climate: 'warm', season: 'Nov–Apr', cost: { stay: 220, food: 70, transport: 25 },
  ...
  { id: 'serengeti', name: 'Serengeti', country: 'Tanzania', emoji: '🦁', c: ['#facc15', '#b45309'], cats: ['Adventure', 'Nature'], climate: 'warm', season: 'Jun–Oct', cost: { stay: 250, food: 50, transport: 30 },
  ...
  { id: 'cairo', name: 'Cairo', country: 'Egypt', emoji: '🐫', c: ['#fbbf24', '#ea580c'], cats: ['Culture', 'City'], climate: 'warm', season: 'Oct–Apr', cost: { stay: 45, food: 15, transport: 6 },
  ...
  { id: 'reykjavik', name: 'Reykjavik', country: 'Iceland', emoji: '🌌', c: ['#818cf8', '#0f172a'], cats: ['Nature', 'Adventure'], climate: 'cold', season: 'Jun–Aug, Nov–Mar (aurora)', cost: { stay: 150, food: 55, transport: 15 },
